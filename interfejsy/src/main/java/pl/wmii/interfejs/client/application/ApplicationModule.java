...
public class ApplicationModule extends AbstractPresenterModule {
   ...
   */
    ...
    bindPresenter(NaglowekPresenter.class, NaglowekPresenter.MyView.class, NaglowekView.class, NaglowekPresenter.MyProxy.class);
    ...
    FORMULARZE
     */
    bindPresenter(FormularzPresenter.class, FormularzPresenter.MyView.class,
            FormularzView.class, FormularzPresenter.MyProxy.class);
    bindPresenter(PomocPresenter.class, PomocPresenter.MyView.class,
            PomocView.class, PomocPresenter.MyProxy.class);
    ...
    bindPresenter(DodajZestawPresenter.class, DodajZestawPresenter.MyView.class,
            DodajZestawView.class, DodajZestawPresenter.MyProxy.class);
    bindPresenter(ZarejestrujPresenter.class, ZarejestrujPresenter.MyView.class,
            ZarejestruView.class, ZarejestrujPresenter.MyProxy.class);
  }
